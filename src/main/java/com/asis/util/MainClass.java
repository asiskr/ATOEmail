...
public class MainClass {
	...
	// Declare the fields without initialization
	...
	public static ArrayList<String> subjectColumnData;
	public static ArrayList<String> pdfFileNames;
	public static ArrayList<String> fileNamesColumn7;
	public static ArrayList<String> firstColumnData;
	...
	public static void initializeClientData() {
		// Initialize only when the method is called
		firstColumn = ClientExcel.readFirstColumn(filePath);
		subjectColumnData = ClientExcel.readSubjectColumn(filePath);
		pdfFileNames = ClientExcel.readPdfFileNamesFromColumn8(filePath);
		fileNamesColumn7 = ClientExcel.readFileNamesFromColumn7(filePath);
	}
